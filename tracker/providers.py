...
def classify(title,url):
    ...
    if re.search(r"newsletter|market.*(?:view|outlook|update)|equity.*(?:outlook|update)|debt.*(?:outlook|update)|factor.*outlook|annual.*outlook|investment.view|cio.*(?:view|letter)|product.?note|presentation",title_text):
        return "market view"
    ...
    if re.search(r"newsletter|market.*(?:view|outlook|update)|equity.*(?:outlook|update)|debt.*(?:outlook|update)|factor.*outlook|annual.*outlook|investment.view|cio.*(?:view|letter)|product.?note|presentation",s): return "market view"
