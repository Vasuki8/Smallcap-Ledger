...
PARSER_UPGRADE_FAMILIES={
    ...
    'amc-reports-2026-09-v46':frozenset({'Bank Of India Small Cap Fund','Baroda Bnp Paribas Small Cap Fund','Franklin India Small Cap Fund','Groww Small Cap Fund','LIC Mf Small Cap Fund','Pgim India Small Cap Fund','Samco Small Cap Fund','Tata Small Cap Fund','UTI Small Cap Fund'}),
}
