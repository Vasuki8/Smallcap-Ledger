...
Validated on 8 September 2026 against the bundled historical archive and downloaded official AMC documents. This report records extraction coverage, not a guarantee that every value is the newest publication. The deployed site regenerates `data/coverage.json` after every build.
...
| Canara Robeco Small Cap Fund | [14,230.88](https://digitalassets.canararobeco.com/digital-factsheet/2026/july/Scheme/Factsheet.pdf) | 2026-07-31 | BER | 86 positions; partial; 2026-07-31 |
...
| HSBC Small Cap Fund | [17,783.74](https://www.assetmanagement.hsbc.co.in/-/media/Files/attachments/india/mutual-funds/factsheet/the-asset-july-2026.pdf) | 2026-07-31 | BER | Gap |
...
| Invesco India Small Cap Fund | [14,474.79](https://www.invescomutualfund.com/docs/default-source/factsheet/invesco-mf-factsheet-july-2026.pdf) | 2026-07-31 | BER | 65 positions; partial; 2026-07-31 |
...
| Mirae Asset Small Cap Fund | [5,220.93](https://www.miraeassetmf.co.in/docs/default-source/fachsheet/active-factsheet---august-2026.pdf) | 2026-07-31 | BER | 10 positions; partial; 2026-07-31 |
| Motilal Oswal Small Cap Fund | [7,604.53](https://www.motilaloswalmf.com/content/dam/motilal-mf/downloads/mf/leafletsbrochures/2026/aug/Motilal%20Oswal%20Small%20Cap%20Fund.pdf) | 2026-07-31 | TER + BER | 61 positions; partial; 2026-07-31 |
...
| SBI Small Cap Fund | [39,942.33](https://www.sbimf.com/docs/default-source/scheme-factsheets/sbi-small-cap-fund-factsheet-july-2026.pdf) | 2026-07-31 | TER + BER | 68 positions; partial; 2026-07-31 |
...
- Current validated coverage is AUM 21/36, expense records 30/36 (29 visible with known plan labels), and portfolios 10/36. This is up from AUM 9/36, expenses 25/36 and portfolios 2/36 in the original deployed package.
- SBI July factsheet adds INR-crore AUM, distinct TER/BER columns, its BSE benchmark identity and 68 equity positions. Mirae June/July reports add AUM, BER and 10-stock snapshots. Motilal Oswal's official brochure and workbook add AUM and 61 ISIN positions.
- Motilal's embedded download fields are now discovered; PDF reports without a `.pdf` URL suffix are recognized. Additional official fund updates and presentations are archived even when no supported dated numeric table is present.

- Added official monthly report sources and download directories; Canara Robeco, Invesco, Mirae Asset and SBI monthly locations roll forward with a three-month lookback.
...
Validation: 39 isolated automated tests, original-report visual spot checks, generated-site validation, and cumulative-history superset checks.
