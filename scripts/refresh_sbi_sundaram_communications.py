...
UPGRADE_KEY="source_upgrade_sbi_sundaram_communications_2026_09_v1"
...
def run():
    ...
    success=bool(
        ...
        and sbi["versions"]>=1
        and b"Executive Summary" in sbi_body
        and b"Rajeev Radhakrishnan" in sbi_body
    ...
    detail=(
        f"SBI={sbi}; SBI identity="
        f"{bool(b'Executive Summary' in sbi_body and b'Rajeev Radhakrishnan' in sbi_body)}; "
        f"Sundaram={sundaram}; Sundaram PDF={sundaram_body.startswith(b'%PDF')}; "
